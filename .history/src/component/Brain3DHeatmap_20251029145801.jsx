...
export function Brain3DHeatmap() {
  ...
  // brain position on screen in pixels
const [brainPos, setBrainPos] = useState({
  x: 900,  // adjust starting position
  y: 350,  // adjust starting position
});
...
function handleBrainMouseDown(e) {
  ...
  // where inside the box did we click?
  ...
  // so text / buttons don't get selected while dragging
  e.preventDefault();
}
